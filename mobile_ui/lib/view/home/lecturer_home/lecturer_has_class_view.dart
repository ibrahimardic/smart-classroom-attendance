...
class LecturerHasClassView extends StatefulWidget {
  const LecturerHasClassView({super.key});

  @override
  State<LecturerHasClassView> createState() => _LecturerHasClassViewState();
}

class _LecturerHasClassViewState extends State<LecturerHasClassView> {
  @override
  void initState() {
                                    ...
                                    children: [
                                      ...
                                      PrimaryButton(
                                        onTap: () async {
                                          router.pop();
                                          await viewModel
                                              .setClassroomDeactive();
                                          await getIt<HomeViewModel>()
                                              .getClasses();
                                          await getIt<HomeViewModel>()
                                              .getUserData();
                                          router.goNamed("/");
                                          print(viewModel.user!.activeClass ==
                                              null);
                                        },
                                        text: "Yes",
                                        width: .3,
