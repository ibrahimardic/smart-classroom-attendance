...
class HasNotClassView extends StatelessWidget {
  final HomeViewModel viewModel;
  const HasNotClassView({super.key, required this.viewModel});
                      ...
                      if (viewModel.classesList[index - 1].isActive) {
                        ...
                        router.push(
                          ...
                          extra: ChooseClassArguments(
                            id: viewModel.classesList[index - 1].docId,
                          ),
                        );
                      }
                    },
                    child: ClassContainerWidget(
                      className: viewModel.classesList[index - 1].docId,
                      isActive: viewModel.classesList[index - 1].isActive,
                      lectureName: viewModel.classesList[index - 1].courseName,
                      lecturerName: viewModel.classesList[index - 1].whoUsing,
                    ),
                  );
                }
              }),
